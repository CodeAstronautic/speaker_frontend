...
export default function Eventpage() {
  ...
  <input className='searchbar' type="text" placeholder="Search by event name, location, or category name" name="search" />
  <button type="submit"><i class="fa fa-search"></i></button>
  <input type="checkbox" className='apply1'name="apply1"/>
      <p className="s1">SpeakerOre Exclusive</p>
      <p className="s2">Events only for SpeakerOre subscribers. All the speaker in these events will be selected among speakers or members.</p>
 ...
 <div className="view-event">
        <div className="event-card">
            ...
            <input type="date" className="e7" placeholder='Date: 27th December 2021'/>
            <p className="e8">ONLINE</p>
            <p className="e4">Tags: Industry, Film, Acting, Speaking </p>
            <p className="e5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Luctus turpis turpis eu adipiscing et. Et enim amet faucibus sed gravida tristique sagittis diam, habitant. Vel morbi viverra nam ac. Justo integer lorem nisl ullamcorper sed. Quam vel placerat.</p>
