...
export default function Footer() {
  ...
  <div className='footer'>
    ...
    <ul className="thirdcolumn">
        <input type="text" className="fc7" placeholder=' Your email address' />
        <button className="fc8" type='submit'>SUBSCRIBE</button>
        <hr />
        <li className="fc9"> Subscribing to SpeakerOre unlocks unlimited events. </li>
