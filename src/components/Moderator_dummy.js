...
export default function Moderator_dummy() {
  return (
    <>
      <div className="mp-parent">
        <div className="mp-left">
          <div className="mp-upper">
            ...
            <div className="mpl-mid">
              <div className="mpl-mid-heading">
                <p>EVENT REQUESTS</p>
                <p>Total Request Pending: 30</p>
              </div>
              <div className="mid-filter">
                <p>Location: </p>
                <input
                  type="text"
                  className="mid-filter-input"
              ...
              <div className="mpl-mid-event">
                <div className="mid-event-card">
                <i className="fa fa-angle-down" style={{float: "right" }}></i>
                  <p>EVENT NAME HERE TILL HERE...</p>
                  
                  <p><i className="far fa-calendar-alt"></i>10.01.2022</p>
                  <p style={{display:"inline" ,float: "right" }}>Online</p>
                  <p><i className="fas fa-map-marker-alt" style={{display:"inline"}} ></i>New Delhi</p>
        ...
        <div className="ep-right">
          <div className="eprcard">
            ...
            <p className="eprtext1">Event Manager</p>
          ...
          <div className="eprcard">
            ...
            <div
              style={{ marginTop: "10px", marginTop: "5rem", background: "#FFBF19"}}
              className="eprbtn1"
            >
              Contact Us
            </div>
