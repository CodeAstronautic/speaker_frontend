      ...
      <div className="main">
        <div className="mainform">
          ...
          <form className="forms">
            ...
            <input type="text" className="input" placeholder="Address Here" />
            <br />
            <p className="label">Topics Covered</p>
            <input type="text" className="input" placeholder="Write" />
            <br />
            <p className="label">Audience Size</p>
            <input type="text" className="input" placeholder="0" />
            <br />
            <p className="label">Payment Terms</p>
            <input type="text" className="input" placeholder="Paid" />
            <br />
          </form>
          <form className="forms2">
            ...
            <input type="text" className="input2" placeholder="Conference " />
            <br />
            <p className="label2">Audience Type </p>
            <input type="text" className="input2" placeholder="0" />
            <br />
